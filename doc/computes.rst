...
.. toctree::
   ...
   compute_ptm_atom
   compute_rattlers_atom
   compute_rdf
   compute_reaxff_atom
   compute_reduce
   compute_reduce_chunk
   compute_rheo_property_atom
   compute_rigid_local
   compute_rigid_local_abrade
   compute_saed
   compute_slcsa_atom
   compute_slice
   ...
   compute_sna_atom
   compute_sph_e_atom
   compute_sph_rho_atom
   compute_sph_t_atom
   compute_spin
   compute_stress_atom
   compute_stress_cartesian
   compute_stress_curvilinear
   compute_stress_mop
   compute_tally
