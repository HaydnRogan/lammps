...
private:
 ...
 protected:
  ...
  // Modified Commflags
  enum{BODY_MASS, FULL_BODY, INITIAL, FINAL, FORCE_TORQUE, VCM, ANGMOM, XCM_VOL, MIN_AREA, EQUALISE, EDGES, WEAR_ENERGY, NEW_ANGLES, MASS_NATOMS, DISPLACE, NORMALS, BODYTAG, ITENSOR, UNWRAP, DOF, ABRADED_FLAG, DISPLACEMENT_VEL, SURFACE_AREA};
